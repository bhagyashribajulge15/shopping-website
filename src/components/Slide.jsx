...
const Slide = ({ img, title, mainTitle, price }) => {
  return (
    <div className="outline-none border-none relative px-10">
      <div
        className="absolute left-[30px] md:left-[70px] max-w-[250px] sm:max-[250px] top-[50%] -translate-y-[50%] space-y-2 lg:space-y-4
